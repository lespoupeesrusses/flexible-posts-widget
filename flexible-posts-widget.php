<?php
/*
 * Plugin Name: Semio Posts Widget
 * Author:         Semiodesign
 * Author URI:  http://www.semiodesign.com
 * Version:     3.1.2
 * Description: An advanced posts display widget with many options: get posts by post type, taxonomy & term; sorting & ordering; feature images; custom templates and more. Based on Flexible Posts Widget
...
class DPE_Flexible_Posts_Widget extends WP_Widget {
   ...
   /**
    ...
    function update( $new_instance, $old_instance ) {
        ...
        $instance['sticky']        = (boolean) $new_instance['sticky'];
